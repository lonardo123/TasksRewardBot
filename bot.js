...
// 📝 أمر /info (شرح طريقة العمل)
bot.command('info', (ctx) => {
  ctx.replyWithHTML(
    `👋 Tasks Rewards Bot أهلاً بك في بوت الربح 💰 

📌 <b>طريقة العمل:</b>

1️⃣ اضغط على زر <b>🎁 مصادر الربح</b> في القائمة.
2️⃣ اختر منصة <b>🕒 TimeWall</b>.
...
- الحد الأدنى: 1$
- اختر "📤 طلب سحب"
- أدخل محفظة <b>Payeer</b> الخاصة بك.
